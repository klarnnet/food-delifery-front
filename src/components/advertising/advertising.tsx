...
export const Advertising = () => {
    const { data } = flatsApi.useGetMyflatsQuery('');
    const [deleteFlat] = flatsApi.useDeleteFlatMutation()
    ...
    const deleteMyFlat = async (e: MouseEvent<HTMLButtonElement, globalThis.MouseEvent>,flatId:any) => {
        e.preventDefault()
        await deleteFavoriteFood(flatId);
        deleteFlat(flatId)
        console.log(flatId)
    };
    ...
    return (
        <div className="advertising">
            <Link className="link" to={'/ad-modal'}>
                <button>+</button>
            </Link>
                    ...
                    (i: any): JSX.Element => (
                        <Link className="link" to={'/modal'} state={{ i: i }}>
                            <div className="items">
                                ...
                                <div>
                                    <button onClick={e => deleteMyFlat(e, i.id)}>Удалить</button>
                                </div>
                            </div>
                        </Link>
                    ),
